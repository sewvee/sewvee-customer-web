                      ...
                      if (hasReviewedAfter) {
                        return (
                          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 my-2 text-center shadow-sm w-full relative overflow-hidden">
                            ...
                            <p className="text-emerald-800 text-[13.5px] leading-snug mb-3">
                              Thank you for providing your feedback!
                            </p>
                            
                            {order?.googleReviewLink && (
                              <div className="mt-4 pt-4 border-t border-emerald-200/60 text-center">
                                <h5 className="font-bold text-emerald-900 text-[14px] mb-1">Support us on Google!</h5>
                                <p className="text-emerald-700 text-[12px] leading-snug mb-3">
