...
const target = `function renderMessageContent(msgText: string, isCustomer: boolean) {`;
const newCode = `function renderMessageContent(msgText: string, isCustomer: boolean) {
...
if (code.includes(target) && !code.includes("[ACTION_REQUIRED: PHOTO_REQUEST]")) {
  ...
  console.log('Successfully patched ACTION_REQUIRED!');
}
